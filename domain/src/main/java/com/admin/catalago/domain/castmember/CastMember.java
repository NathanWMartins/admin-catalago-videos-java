...
import com.admin.catalago.domain.AggregateRoot;
import com.admin.catalago.domain.exceptions.NotificationExceptions;
import com.admin.catalago.domain.utils.InstantUtils;
...
public class CastMember extends AggregateRoot<CastMemberID> {
    ...
    private void selfValidate() {
        ...
        if (notification.hasError()) {
            throw new NotificationExceptions("Failed to create a Aggregate CastMember", notification);
        }
    }
}