...
import com.admin.catalago.application.video.create.CreateVideoCommand;
...
import com.admin.catalago.application.video.media.get.GetMediaCommand;
import com.admin.catalago.application.video.media.get.GetMediaUseCase;
import com.admin.catalago.application.video.media.upload.UploadMediaCommand;
...
import com.admin.catalago.application.video.update.UpdateVideoCommand;
...
import com.admin.catalago.infrasctructure.api.VideoAPI;
import com.admin.catalago.infrasctructure.utils.HashingUtils;
import com.admin.catalago.infrasctructure.video.models.CreateVideoRequest;
import com.admin.catalago.infrasctructure.video.models.UpdateVideoRequest;
import com.admin.catalago.infrasctructure.video.models.VideoListResponse;
import com.admin.catalago.infrasctructure.video.models.VideoResponse;
import com.admin.catalago.infrasctructure.video.presenters.VideoApiPresenter;
...
public class VideoController implements VideoAPI {
    ...
    public ResponseEntity<?> uploadMediaByType(final String id, final String type, final MultipartFile media) {
        final var aType = VideoMediaType.of(type)
                .orElseThrow(() -> NotificationExceptions.with(new Error("Invalid %s for VideoMediaType".formatted(type))));
