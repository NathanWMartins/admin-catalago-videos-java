package com.admin.catalago.infrasctructure.video.persistence;
...
import com.admin.catalago.domain.video.VideoPreview;
...
public interface VideoRepository extends JpaRepository<VideoJpaEntity, String> {
    @Query("""
            select distinct new com.admin.catalogo.domain.video.VideoPreview(
                v.id as id,
                v.title as title,
