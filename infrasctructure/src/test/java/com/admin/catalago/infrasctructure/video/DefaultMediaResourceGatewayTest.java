...
import static com.admin.catalago.domain.Fixture.Videos.mediaType;
import static com.admin.catalago.domain.Fixture.Videos.resource;
...
class DefaultMediaResourceGatewayTest {
    ...
    public void givenInvalidType_whenCallsGetResource_shouldReturnEmpty() {
        // given
        final var videoOne = VideoID.unique();
        final var expectedType = VideoMediaType.THUMB;
